...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
    public static final String passUrls =
        "/attachment/**,/login/**,/assets/**,/admin/**,/component/**,/favicon.ico,/demo/**"
            + ",/register/**,/zsnews/**,/share/**";
        ...
        throws Exception
    {
        ...
        http.addFilterBefore(new AuthenticationTokenFilter(securityUserDetailsService),
